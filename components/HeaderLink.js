...
function HeaderLink({Icon,text,avatar,feed,active,hidden}) {
  ...
  return (
    <div className={` ${hidden && "hidden md:inline-flex "} cursor-pointer flex flex-col justify-center
     items-center ${feed ? "text-black/60 hover:text-gray dark:text-white/75 dark:hover:text-white lg:-mb-1.5 space-y-1"
