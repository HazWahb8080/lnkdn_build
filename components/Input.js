...
export default function Input({}){
    ...
    return(
        <div className="bg-white dark:bg-[#1D2226] rounded-lg p-3 space-y-3 border border-gray-300 dark:border-transparent">
           <div className="space-x-2 items-center flex">
               <Avatar src={session?.user?.image} className="!-10 !w-10 cursor-pointer"/>
                <motion.button
