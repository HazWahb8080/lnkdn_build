...
function Widgets({articles}) {
  return (
     ...
     {/* Ads */}
      <div className="bg-white dark:bg-[#1D2226] w-11/12 h-64 rounded-lg sticky top-20 border border-gray-300 dark:border-none">
        <div className="relative w-full h-full">
          <Image
          className="rounded-lg"
            src="https://ucarecdn.com/906a58c2-da9c-46be-b6dc-0624e589e88a/1.jpg"
            layout="fill"
            objectFit="cover"
            priority
          />
